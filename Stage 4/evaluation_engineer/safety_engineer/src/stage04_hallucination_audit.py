...
_SAFETY_DIR = os.path.dirname(_HERE)
_EVAL_DIR = os.path.dirname(_SAFETY_DIR)
_STAGE4_DIR = os.path.dirname(_EVAL_DIR)


DEFAULT_PREDICTIONS_PATH = os.path.join(_SAFETY_DIR, "outputs", "stage04_test_predictions.jsonl")
...
DEFAULT_OUTPUT_REPORT = os.path.join(_SAFETY_DIR, "outputs", "stage04_clinical_safety_report.json")
